...
test('a no-JavaScript form submission returns an understandable result page', async ({ browser }) => {
  ...
  await page.getByRole('button', { name: 'Send Inquiry' }).click({ force: true })
