...
- 定向 unit：107/107；Task 14 定向 contract：16/16；完整 `pnpm test:contract`：8 files / 97 tests passed。
- 完整 `pnpm test:unit`：205 files / 1821 tests passed（含 AI evaluation gate 60/60）。
