...
| 社媒会话 AI 出站回复          | `blocked`     | 入站 adapter 在没有出站授权时会持久人工接管，避免伪造已发送 AI 回复；出站 contract / fake 由 ADR-0003 约束，尚未形成真实 adapter     | 对应账号 / 权限 / 消息窗口、`PlatformAccounts`、持久 Job handler、平台 adapter、受控真实入站与出站验证 |
