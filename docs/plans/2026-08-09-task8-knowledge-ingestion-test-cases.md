...
- 回归：同步最新 `origin/main` 后 unit 113 files / 779 tests、integration 29 files / 172 tests、contract 7 files / 70 tests、知识 Portal Chromium E2E 3 tests、build、migration up/down/up 均通过。
