...
export const WEBSITE_COPY = {
  en: {
    ...
    contact: {
      ...
      emailCard: 'Email',
      formFallback:
        'Secure online submission will be enabled with the Task 7 inquiry workflow. No inquiry has been sent yet.',
  ...
  ar: {
    ...
    contact: {
      ...
      formFallback:
        'سيتم تفعيل الإرسال الآمن ضمن مسار الاستفسارات في المهمة 7. لم يتم إرسال الاستفسار بعد.',
      ...
      name: 'الاسم *',
      productOptions: [
        'ألواح ألمنيوم مزدوجة الانحناء',
        'ألواح ألمنيوم أحادية الانحناء',
        'ألواح ألمنيوم مصمتة',
      ],
