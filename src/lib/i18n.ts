...
export const WEBSITE_COPY = {
  en: {
    ...
    chat: {
      ...
      sampleQuestionsLabel: 'Suggested inquiries',
      send: 'Send',
      sending: 'Sending…',
    ...
    contact: {
      ...
      attachmentsBrowse: 'Browse files',
      attachmentsCancel: 'Cancel',
      attachmentsCounter: '{count}/5 files',
      attachmentsDrop: 'Drag and drop drawings or BOQ here, or',
      attachmentsFileTooLarge: 'Each attachment must be 50 MB or smaller.',
      attachmentsHelp: 'Upload shop drawings, BOQ, or specifications (.dwg, .dxf, .step, .pdf, .xlsx, .zip, etc.). Max 5 files, up to 50 MB each.',
      attachmentsInvalidFileType: 'File type or format is not supported.',
      attachmentsLimit: 'Max 5 files, up to 50 MB each (200 MB total)',
      attachmentsMaxFilesReached: 'Maximum 5 attachments allowed per inquiry.',
      attachmentsPendingWait: 'Please wait for all attachments to finish uploading before sending.',
      attachmentsRemove: 'Remove',
      attachmentsRetry: 'Retry',
      attachmentsTotalSizeExceeded: 'Total attachment size must not exceed 200 MB.',
      attachmentsUploaded: 'Uploaded',
      attachmentsUploadFailed: 'Upload failed. Click retry to try again.',
  ...
  ar: {
    ...
    chat: {
      ...
      sampleQuestionsLabel: 'استفسارات مقترحة',
      send: 'إرسال',
    ...
    contact: {
      attachments: 'الرسومات والمستندات',
      attachmentsBrowse: 'استعراض الملفات',
      attachmentsCancel: 'إلغاء',
      attachmentsCounter: '{count}/5 ملفات',
      attachmentsDrop: 'اسحب وأفلت الرسومات أو جداول الكميات هنا، أو',
      attachmentsFileTooLarge: 'يجب أن يكون حجم كل مرفق 50 ميغابايت أو أقل.',
      attachmentsHelp: 'تحميل الرسومات التنفيذية أو جداول الكميات أو المواصفات (DWG، DXF، STEP، PDF، XLSX، ZIP، إلخ). حتى 5 ملفات، بحد أقصى 50 ميغابايت لكل ملف.',
      attachmentsInvalidFileType: 'نوع الملف أو صيغته غير مدعومة.',
      attachmentsLimit: 'بحد أقصى 5 ملفات، 50 ميغابايت لكل ملف (إجمالي 200 ميغابايت)',
      attachmentsMaxFilesReached: 'الحد الأقصى 5 مرفقات لكل استفسار.',
      attachmentsPendingWait: 'يرجى الانتظار حتى يكتمل تحميل جميع المرفقات قبل الإرسال.',
      attachmentsRemove: 'إزالة',
      attachmentsRetry: 'إعادة المحاولة',
      attachmentsTotalSizeExceeded: 'يجب ألا يتجاوز إجمالي حجم المرفقات 200 ميغابايت.',
      attachmentsUploaded: 'تم التحميل',
      attachmentsUploadFailed: 'فشل التحميل. اضغط إعادة المحاولة.',
      attachmentsUploading: 'جارٍ التحميل…',
      company: 'الشركة',
      country: 'الدولة *',
      countryOptions: [
