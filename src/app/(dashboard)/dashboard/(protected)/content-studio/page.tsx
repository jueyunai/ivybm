...
import {
  ContentStudioPageReadError,
  loadContentStudioPageData,
  parseContentStudioQuery,
  type ContentStudioPageData,
...
export default async function ContentStudioPage({
  ...
  try {
    ...
    data = await loadContentStudioPageData({
      env: process.env,
      payload,
      query,
    ...
    console.error('portal_content_studio_read_failed', {
      error: error instanceof ContentStudioPageReadError ? error.code : 'unknown',
    })
