...
export const PORTAL_EN = {
  ...
  knowledgeWorkspace: {
    ...
    ingestion: {
      ...
      errorSummaries: {
        ...
        'image-total-too-large': 'The embedded images exceed the 40MB total limit. Compress the images and retry.',
        'ingestion-failed': 'The document could not be processed. Retry later or contact an administrator.',
        ...
        'invalid-file': 'The uploaded file is invalid or corrupted. Export it again and retry.',
        'invalid-file-name': 'The file name is invalid. Rename the file and retry.',
        'invalid-image': 'The uploaded image is invalid. Export it again and retry.',
        'invalid-image-name': 'The image file name is invalid. Rename the file and retry.',
        ...
        'unsupported-file-type': 'Only DOCX and PDF files are allowed. Convert the file and upload again.',
  ...
  settings: {
    ...
    chinese: '中文',
    confirmDeleteMember: 'Confirm deletion',
    confirmUsernamePrompt: 'Type the member username to confirm deletion:',
    ...
    memberCreatedAt: 'Created at',
    memberEmail: 'Login email',
    ...
    newMemberTitle: 'Add team member',
    newPassword: 'New password',
    nextStep: 'Next step',
    noSiteDescription: 'No site description has been provided.',
    noTeamMembers: 'No team members found.',
    passwordLengthHint: 'Password must be 12 to 128 characters long',
    passwordMismatch: 'Passwords do not match',
    copyPassword: 'Copy',
    copyPasswordSuccess: 'Initial password copied.',
    generatePassword: 'Regenerate',
    permissionAll: 'Select all',
    permissionCustom: 'Custom',
    permissionEdit: 'Edit',
    permissionEditable: 'Editable',
    permissionMatrix: 'Module permissions',
    permissionNone: 'Clear all',
    permissionRequired: 'Required',
    permissionTemplate: 'Permission template',
    permissionView: 'View',
    permissionViewOnly: 'Read only',
    ...
    roleSalesOption: 'Sales representative',
    roleTemplateTag: 'Optional Preset',
    roleTemplateTip: 'Select to quickly apply preset permissions',
    saveMember: 'Save',
    ...
    statusManuallyLocked: 'Locked by admin',
    statusNormal: 'Normal',
    statusSecurityLocked: 'Temporarily locked (failed logins)',
    systemTheme: 'System',
    username: 'Username',
    ...
    teamErrorMessages: {
      'username-already-exists': 'That username is already in use. Choose another username.',
