...
export const contentStudioMessages = {
  en: {
    ...
    uploadPrompt: 'Click or drop one image here',
    uploadingMedia: 'Uploading image...',
    uploadFailed: 'Failed to upload media. Please try again.',
    uploadCountExceeded: 'Select one image at a time.',
    ...
    inferredFormatNotice: 'Current platform publishing supports one image per draft.',
