...
const qualificationCopy = {
  en: { budget: 'Budget', drawings: 'Drawings available', no: 'No', procurementPlan: 'Procurement plan', projectStage: 'Project stage', quantity: 'Quantity (sqm)', timeline: 'Purchase timeline', unknown: 'Not provided', yes: 'Yes' },
  zh: { budget: '预算', drawings: '已有图纸', no: '否', procurementPlan: '采购计划', projectStage: '项目阶段', quantity: '数量（平方米）', timeline: '采购时间', unknown: '未提供', yes: '是' },
} as const
