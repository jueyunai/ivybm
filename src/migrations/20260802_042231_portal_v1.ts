...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "generated_contents" ADD CONSTRAINT "generated_contents_created_by_id_users_id_fk" FOREIGN KEY ("created_by_id") REFERENCES "public"."users"("id") ON DELETE restrict ON UPDATE no action;
  ...
  ALTER TABLE "content_reviews" ADD CONSTRAINT "content_reviews_content_id_generated_contents_id_fk" FOREIGN KEY ("content_id") REFERENCES "public"."generated_contents"("id") ON DELETE restrict ON UPDATE no action;
  ALTER TABLE "content_reviews" ADD CONSTRAINT "content_reviews_reviewed_by_id_users_id_fk" FOREIGN KEY ("reviewed_by_id") REFERENCES "public"."users"("id") ON DELETE restrict ON UPDATE no action;
  ALTER TABLE "publish_jobs" ADD CONSTRAINT "publish_jobs_content_id_generated_contents_id_fk" FOREIGN KEY ("content_id") REFERENCES "public"."generated_contents"("id") ON DELETE restrict ON UPDATE no action;
  ...
  ALTER TABLE "publish_jobs" ADD CONSTRAINT "publish_jobs_created_by_id_users_id_fk" FOREIGN KEY ("created_by_id") REFERENCES "public"."users"("id") ON DELETE restrict ON UPDATE no action;
  ALTER TABLE "publish_logs" ADD CONSTRAINT "publish_logs_publish_job_id_publish_jobs_id_fk" FOREIGN KEY ("publish_job_id") REFERENCES "public"."publish_jobs"("id") ON DELETE restrict ON UPDATE no action;
  ...
  ALTER TABLE "portal_command_receipts" ADD CONSTRAINT "portal_command_receipts_actor_id_users_id_fk" FOREIGN KEY ("actor_id") REFERENCES "public"."users"("id") ON DELETE restrict ON UPDATE no action;
